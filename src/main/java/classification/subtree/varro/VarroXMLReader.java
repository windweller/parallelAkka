...
public class VarroXMLReader {
    ...
    public void process(double percentage, boolean unilateral) {
        ...
        Map<String, Double> sorted = handler.subtreeList.entrySet().stream()
                .sorted(Map.Entry.comparingByValue()).collect(Collectors.toMap(Entry::getKey, Map.Entry::getValue));
    ...
    public void generateLDAFile(double percentage) {
        ...
        Map<String, Double> sorted = handler.subtreeList.entrySet().stream()
                .sorted(Map.Entry.comparingByValue()).limit(size).collect(Collectors.toMap(Entry::getKey, Map.Entry::getValue));
